...
class ForgeExtension :
    ...
    override fun provideTestTemplateInvocationContexts(context: ExtensionContext): Stream<TestTemplateInvocationContext> {
        ...
        // val displayName: String = context.displayName
        // val formatter = ShrinkingNameFormatter(displayName)
...
//            System.err.println(getErrorMessage(context) + ";  We're still shrinking.")
            return
        }
    ...
    private fun resolveShrinkingParameter(
        ...
        if (previousReports == null || previousReports.isEmpty()) {
            println("No previous report found for $parentUniqueId")
        ...
        if (shrinkingResolver == null) {
            println("No shrinking resolver found for ${parameterContext.parameter.name}")
            return resolveRandomParameter(parameterContext, extensionContext)
        }
